...
{
    public partial class Openrecipe2 : Form
    {
        ...
        private void Openrecipe2_Load(object sender, EventArgs e)
        {
            ...
            else if (RecipeType.labelstring == "Cassette Recipe Name")
            {
                ...
                SqlCommand cmd = new SqlCommand(strSQL, con);
                cmd.Parameters.AddWithValue("@Newrecipename", OpenCassetteWafer.strsearchname);
                SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    // listboxnewrecipe.Items.Add(reader["StepName"]);
